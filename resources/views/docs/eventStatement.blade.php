                        ...
                        <table class="table table-striped">
                            <thead>
                              ...
                              <tr style="padding-top:0px; padding-bottom:0px;">
                                ...
                                <th style="padding-top:0px; padding-bottom:0px;">Event Title</th>
                                <th style="padding-top:0px; padding-bottom:0px;">Reference</th>
                                <th style="padding-top:0px; padding-bottom:0px;">Event Price</th>
                                <th style="padding-top:0px; padding-bottom:0px;">Event Amount Paid</th>
                              </tr>
                            </thead>
                            <tbody style="padding-top:0px; padding-bottom:0px;">
                              ...
                              <tr>
                                ...
                                <td style="padding-top:0px; padding-bottom:0px;">{{$entry['meeting_title']}}</td>
                                <td style="padding-top:0px; padding-bottom:0px;">{{$entry['reference']}}</td>
                                <td style="padding-top:0px; padding-bottom:0px;">{{$entry['amount']}}</td>
