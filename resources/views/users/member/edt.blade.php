        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-20 pt-2">
                        <form action="{{ route('user.tenant.update', $tenant->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        value="{{  $tenant->full_name }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="id_number" value="{{  $tenant->id_number}}"    id="passport" readonly>
                                    </div>
                                </div>
                            </div>
