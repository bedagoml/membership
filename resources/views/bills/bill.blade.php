                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 m-b-20">
                            <img src="{{URL::asset('assets/assets/images/brand/logo-3.png')}}" height="auto" width="200px" class="inv-logo" alt="">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    @if($payowners->bill_category == 'project')
                                    <td class="d-none d-sm-table-cell"> Project - {{$payowners->bill_type}} - {{$payowners->description}} </td>
