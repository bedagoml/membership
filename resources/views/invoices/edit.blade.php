                                ...
                                <div class="row">
                                     ...
                                     <div class="col-sm-4" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="@if($invoice->tenant_id != null){{$invoice->tenant->member_number}}@else No Member Number Assigned @endif" readonly>
                                    ...
                                    <div class="col-sm-4" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="form-group">
                                                 @if($invoice->type == "First Subscription Invoice")  
                                                        <input class="form-control" type="number" name="amount"
                                                value="{{$invoice->amount}}" >
                                               @else
                                               <input class="form-control" type="number" name="renewal"
                                               value="{{$invoice->renewal}}" >
                                               @endif
                                                </div>
