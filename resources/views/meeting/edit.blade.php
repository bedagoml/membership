...
@section('content')
	...
	<form action="{{route('meeting.update', $event->id)}}" method="post" class="card">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="meeting_description" class="form-control" rows="6"  >{{$event->meeting_description}}</textarea>
