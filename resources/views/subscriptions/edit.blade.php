                        ...
                        <div class="card">
                            ...
                            <div>
                                <input class="form-control"   name="subscription_date"
                                    value="{{ $subscription->subscription_date}}" readonly>
                            </div>
                            </div>
                            <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label >Registration Amount<span class="text-danger">*</span></label>
                                           <div>
                                            ...
                                            value="{{ $subscription->registration_amount}}">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label>Notes </label>
                                                    <textarea name="description" class="form-control" rows="6" value="{{ $subscription->description}}" ></textarea>
