								...
								<div class="card-body">
									<div class="row">
										<div class="col">
											...
											<h3 class="mb-2 number-font">{{ $tenants }}</h3>
								...
								<div class="card-body">
									<div class="row">
										<div class="col">
											...
											<h3 class="mb-2 number-font">Ksh.{{number_format($paid_invoices)  }}</h3>
										</div>
										<div class="col col-auto">
								...
								<div class="card-body">
									<div class="row">
										<div class="col">
											...
											<h3 class="mb-2 number-font">Ksh.{{number_format($unpaid_invoices)  }}</h3>
										</div>
										<div class="col col-auto">
						...
						<div class="row">
							...
							<div class="col-xl-12 col-lg-6">
								<div class="row">
									...
									<!--					<h2 class="mb-0 font-weight-bold">Ksh.{{number_format($income_today)  }}</h2>-->
									<!--				</div>-->
									<!--				<div class="col col-auto">-->
									<!--					<div id="spark1"></div>-->
									<!--				</div>-->
									...
									<!--					<h2 class="mb-0 font-weight-bold">Ksh.{{number_format($month_income)  }}</h2>-->
									<!--				</div>-->
									<!--				<div class="col col-auto">-->
									<!--					<div id="spark2"></div>-->
									<!--				</div>-->
									...
									<!--					<h2 class="mb-0 font-weight-bold">Ksh.{{number_format($bill_today)}}</h2>-->
									<!--				</div>-->
									<!--				<div class="col col-auto">-->
									<!--					<div id="spark3"></div>-->
									<!--				</div>-->
									...
									<!--					<h2 class="mb-0 font-weight-bold">Ksh.{{number_format($month_bill)}}</h2>-->
									<!--				</div>-->
									<!--				<div class="col col-auto">-->
									<!--					<div id="spark3"></div>-->
									<!--				</div>-->
