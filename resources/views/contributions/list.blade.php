                         ...
                         <table class="table table-striped dt-responsive" id="upcoming_events-table"  style="word-wrap:break-word; table-layout: fixed;  border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="word-wrap: break-word;">{{ $event->project_title }}</td>
                                    <td>{{ $event->project_date }}</td>
                           ...
                           <div class="dropdown-item ">
                                        <a class="btn btn-sm btn-info btn-block" href="{{route('contribution_project.show', $event->id)}}"> View</a>
                                    </div>
                                    @endif
                                     @if( Auth::user()->event_editing_delete==1  )
                                    <div class="dropdown-item ">
                                        <a class="btn btn-sm btn-success btn-block" href="{{route('contribution_project.edit', $event->id)}}"> Edit</a>
                                    </div>
                                    @endif
                            </div>
                        </div>
