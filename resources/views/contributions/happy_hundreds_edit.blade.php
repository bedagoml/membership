...
@section('content')
     ...
     <form action="{{ route('happy_hundreds.update', $happy_hundred->id)}}" method="post" class="card">
        @csrf
                        ...
                        <div class="row">
                            <div id="tenantSelector" class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id">
                                    ...
                                    <option value="{{$happy_hundred->tenant_id}}" selected>{{$happy_hundred->tenant->full_name}}</option>
                            ...
                            <div class="col-md-6">
                                <label>Transaction Code<span class="text-danger">*</span></label>
                                    <div>
                                        ...
                                        value="{{$happy_hundred->transaction_code}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control select2-show-search"  name="payment_type">
                                    ...
                                    <option selected value="{{$happy_hundred->payment_type}}">{{$happy_hundred->payment_type}}</option>
                                    ...
                                    <div class="form-group">
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="date" name="payment_date"
                                                value="{{$happy_hundred->payment_date}}">
                                        </div>
                                    </div>
