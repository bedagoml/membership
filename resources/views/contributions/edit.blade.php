...
@section('content')
	...
	<form action="{{route('contribution_project.update', $event->id)}}" method="post" class="card">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="project_description" class="form-control" rows="6"  >{{$event->project_description}}</textarea>
