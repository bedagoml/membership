                         ...
                         <table class="table table-striped dt-responsive" id="upcoming_events-table"  style="word-wrap:break-word; table-layout: fixed;  border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="word-wrap: break-word;"><?php echo e($event->project_title); ?></td>
                                    <td><?php echo e($event->project_date); ?></td>
                           ...
                           <div class="dropdown-item ">
                                        <a class="btn btn-sm btn-info btn-block" href="<?php echo e(route('contribution_project.show', $event->id)); ?>"> View</a>
                                    </div>
                                    <?php endif; ?>
                                     <?php if( Auth::user()->event_editing_delete==1  ): ?>
                                    <div class="dropdown-item ">
                                        <a class="btn btn-sm btn-success btn-block" href="<?php echo e(route('contribution_project.edit', $event->id)); ?>"> Edit</a>
                                    </div>
                                    <?php endif; ?>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotary\rotary\resources\views/contributions/list.blade.php ENDPATH**/ ?>