						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									<li class="breadcrumb-item"><a href="#">Suscription Fees</a></li>
									<li class="breadcrumb-item active" aria-current="page">Suscription Fees List</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
                        ...
                        <table class="table table-striped"  id="invoices-table" style="width:100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:10%">Membership Type</th>
                                    
                                    <th style="width:20%">Reg. Amount</th>
                                    <th style="width:20%">Renewal Amount</th>
                                    <th style="width:20%">License Amount</th>
                                    <th style="width:20%">Submitted on</th>
                                    <th style="width:30%">LastUpdated</th>                                    
...
<script>
    $(function () {
        $('#invoices-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.subscription.list'); ?>',
            "order": [[ 2, "desc" ]],
            columns: [ 
               { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false},     
                    ...
                    //  { data: 'bills', name: 'bills' },
                     { data: 'registration_amount', name: 'registration_amount', orderable: false},
                    { data: 'renewal_amount', name: 'renewal_amount', orderable: false, searchable: false },                     
                     { data: 'license_amount', name: 'license_amount', orderable: false, searchable: false },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/subscriptions/list.blade.php ENDPATH**/ ?>