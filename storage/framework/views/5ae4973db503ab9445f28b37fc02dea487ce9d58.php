                        ...
                        <div class="row">
                            ...
                            <div id="invoiceSelector" class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id">
                                    ...
                                    <option selected disabled>-----Select-----</option>
                                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option value="<?php echo e($inv->id); ?>">Type: <?php echo e($inv->type); ?> Member: <?php echo e($inv->tenant_id); ?> Balance: <?php echo e($inv->balance); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rent\rms\resources\views/manualinvoices/pay.blade.php ENDPATH**/ ?>