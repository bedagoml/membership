	...
	<!-- META DATA -->
		...
		<!-- SIDE-MENU CSS -->
		<link href="<?php echo e(URL::asset('assets/assets/css/sidemenu.css')); ?>" rel="stylesheet" />
		...
		<!-- SIDEBAR CSS -->
		<link href="<?php echo e(URL::asset('assets/assets/plugins/sidebar/sidebar.css')); ?>" rel="stylesheet">

		<!-- SELECT2 CSS -->
		<link href="<?php echo e(URL::asset('assets/assets/plugins/select2/select2.min.css')); ?>" rel="stylesheet"/>

		<!-- INTERNAL Data table css -->
		<link href="<?php echo e(URL::asset('assets/assets/plugins/datatable/css/dataTables.bootstrap5.css')); ?>" rel="stylesheet" />
		<link href="<?php echo e(URL::asset('assets/assets/plugins/datatable/responsive.bootstrap5.css')); ?>" rel="stylesheet" />

		<!-- COLOR SKIN CSS -->
		<link id="theme" rel="stylesheet" type="text/css" media="all" href="<?php echo e(URL::asset('assets/assets/colors/color1.css')); ?>" />
        <?php echo $__env->yieldContent('css'); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/layouts/head.blade.php ENDPATH**/ ?>