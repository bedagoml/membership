						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Schedule Event</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('meeting.store')); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                        <label >Amount</label>
                                           <div>
                                            <div class="form-group">
                                                <input class="form-control " placeholder="Enter Event Amount (Leave blank for free events)" type="number" name="meeting_amount"
                                            value="">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="meeting_description" class="form-control" rows="6"  ></textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Schedule Event</button></button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/meeting/index.blade.php ENDPATH**/ ?>