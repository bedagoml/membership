...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-md-12">
                                ...
                                Status:
                                    ...
                                    <?php endif; ?>
                                        ...
                                        Account Number: <?php if($invoice->tenant_id > 0): ?>
                                              <?php echo e($invoice->tenant->member_number); ?>
                                ...
                                <?php if( $invoice->type == 'First Subscription Invoice' || $invoice->type == 'Event Invoice' || $invoice->type == 'Member Invoice'): ?>
                                ...
                                <?php endif; ?>
                                <?php if($invoice->type == 'Event Invoice'): ?>
                               
                                <tr>
                              
                                    <td class="d-none d-sm-table-cell"> Event Amount - <?php echo e($invoice->description); ?> </td>
                                    <td class="text-right">Ksh <?php echo e(number_format($invoice->renewal)); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($invoice->type == 'Member Invoice'): ?>
                               
                                <tr>
                              
                                    <td class="d-none d-sm-table-cell"> Manual Invoice Amount - <?php echo e($invoice->description); ?> </td>
                                    <td class="text-right">Ksh <?php echo e(number_format($invoice->renewal)); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($invoice->license > 0): ?>
                                <tr>
                              
                                    <td class="d-none d-sm-table-cell"> Accreditation/License Amount</td>
                                    <td class="text-right">Ksh <?php echo e(number_format($invoice->license)); ?></td>
                                </tr>
                                <?php endif; ?>
                            ...
                            <p class="text-muted"><br>
                                ...
                                Account Number <strong> <?php echo e($invoice->invoice_number); ?></strong><br/>
                                Amount <strong> <?php echo e($invoice->balance); ?></strong><br/>
...
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\membership\rms\resources\views/users/member/invoice.blade.php ENDPATH**/ ?>