                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <select id="placementSelector" class="form-control select2-show-search" style="width: 100%"  name="type">
                                ...
                                <option value="annual_subscription" selected>Annual Subscription Fee</option>
                            ...
                            <div class="col-sm-6" >
                                <div class="form-group">
                                    <label id="tenantName"> Member Name<span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                        <label id="tenantPhone">Member Phone Number<span class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                        <label id="placement_amount">Subscription Fee Amount<span class="text-danger">*</span></label>
                                        <label id="management_amount">Foundation Amount<span class="text-danger">*</span></label>
                                        <label id="viewing_amount">Donation Amount<span class="text-danger">*</span></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rent\rms\resources\views/manualinvoices/create.blade.php ENDPATH**/ ?>