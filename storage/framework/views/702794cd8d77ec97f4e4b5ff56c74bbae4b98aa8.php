						...
						<form method="POST" action="<?php echo e(route('password.email')); ?>">
							...
							<div class="form-group">
								<div class="input-group mb-4">
								 <input id="email" type="email" placeholder="Email Address"  style="width:100%" class="input100  <?php if ($errors->has('email')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('email'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" value="" required autocomplete="email">
...
if (isset($messageCache)) { $message = $messageCache; }
							...
							<div class="account-footer">
								<p>Remembered your password? <a href="<?php echo e(route('home')); ?>">Login</a></p>
							</div>
						</form>
							</div>
...
<?php /**PATH C:\xampp\htdocs\rent\rms\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>