				...
				<div class="">
					...
					<div class="container-login100 col-sm-12" style="align-text: center;">
						...
						<div class="wrap-login100 p-0" >
							<div class="card-body">
								<form action="<?php echo e(route('tenant_register.store')); ?>" method="post" enctype="multipart/form-data" >
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-auto">                                
										<?php if(Route::has('password.request')): ?>
											...
											Already have an account? <a class="text-primary" href="<?php echo e(route('tenant.login')); ?>">
												Login
											</a>
										<?php endif; ?>
									</div><br>
...
<?php /**PATH /home/democlai/public_html/members/rms/resources/views/auth/register.blade.php ENDPATH**/ ?>