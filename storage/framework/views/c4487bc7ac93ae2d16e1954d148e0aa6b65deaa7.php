    ...
    <!-- PAGE-HEADER -->
						<div class="page-header">
							...
							<div class="ms-auto pageheader-btn">
								...
								<?php if($tenant->register_status==1): ?>
								...
								<?php endif; ?>
                               <?php if($tenant->suspend_status==1): ?>
                    ...
                    <div class="card  flex-fill">
                        <div class="card-body">
                           ...
                           <div class="profile-info-left">
                                        ...
                                        <div class="staff-id"><strong>Account Number :</strong> <?php echo e($tenant->account_number); ?></div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\membership\rms\resources\views/members/show.blade.php ENDPATH**/ ?>