                        ...
                        <div class="card-body">
                           ...
                           <div class="profile-info-left">
                                        ...
                                        <div class="mb-2"><a class="btn btn-sm btn-primary"
                                                href="<?php echo e(route('user.tenant.edit', $tenant->id )); ?>">Edit details</a>&nbsp;
                    ...
                    <div class="card  flex-fill">
                        <div class="card-body">
                           ...
                           <div class="profile-info-left">
                                        ...
                                        <div class="staff-id"><strong>Member Number :</strong> <?php echo e($tenant->member_number); ?></div>
                    ...
                    <div class="card  flex-fill">
                        <div class="card-body">
                            <h3 class="card-title"> Subscription Details </h3>
                                 <div class="staff-id"><strong>Year :</strong> <?php echo e($tenant->subscription_year); ?> </div>
                                        ...
                                        <?php endif; ?></div> 
                                        <div class="staff-id"><strong>Balance :</strong> <?php echo e(number_format($invoizzy)); ?> </div> 
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        ...
                                                        <div class="dropdown-item ">
                                                            <a class="btn btn-info btn-block" href="<?php echo e(route('user_invoice.show', $invoice->id)); ?>"> View</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-sm btn-info btn-block" href="<?php echo e(route('meeting.invoice', $evnt->id)); ?>"  onclick="event.preventDefault();
                                                    document.getElementById('meeting_invoices').submit();"> Register</a>
                                                <form id="meeting_invoices" action="<?php echo e(route('meeting.invoice', $evnt->id)); ?>" method="POST" style="display: none;">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/users/member/index.blade.php ENDPATH**/ ?>