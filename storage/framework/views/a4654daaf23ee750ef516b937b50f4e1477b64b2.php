				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="<?php echo e(route('report.eventform')); ?>" class="slide-item">Event Registration</a></li>
...
<?php /**PATH /home/democlai/public_html/members/rms/resources/views/layouts/side-menu.blade.php ENDPATH**/ ?>