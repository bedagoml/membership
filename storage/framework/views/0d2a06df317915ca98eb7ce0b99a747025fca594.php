...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('contribution_project.update', $event->id)); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                            <label>Project Deadline Date<span class="text-danger">*</span></label>
                            <div>
                                <input class="form-control" type="date"  name="project_date"
                                    value="<?php echo e($event->project_date); ?>">
                            </div>
                            </div>
                            <div class="col-sm-6" >
                                <div class="form-group">
                                    <label >Project Title<span class="text-danger">*</span></label>
                                       <div>
                                        <div class="form-group">
                                            <input class="form-control " placeholder="Enter Project Title" type="text" name="project_title"
                                        value="<?php echo e($event->project_title); ?>">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="project_description" class="form-control" rows="6"  ><?php echo e($event->project_description); ?></textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Edit Project Details</button></button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotary\rotary\resources\views/contributions/edit.blade.php ENDPATH**/ ?>