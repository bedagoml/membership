...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('contribution_project.store')); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="project_description" class="form-control" rows="6"  ></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotary\rotary\resources\views/contributions/index.blade.php ENDPATH**/ ?>