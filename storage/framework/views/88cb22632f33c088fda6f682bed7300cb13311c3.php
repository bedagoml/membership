                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <select id="invoiceTypeSelector" class="form-control select2-show-search" style="width: 100%" name="invoice_type">
                                        ...
                                        <option value="member_invoice" selected> Invoice</option>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div>
                                         <div class="form-group">
                                            <input class="form-control " type="text" id="example-text-input" name="type"
                                            value="Member Invoice" readonly>
                        ...
                        <div class="row">
                            ...
                            <div id="invoiceSelector" class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id">
                                    ...
                                    <option selected disabled>-----Select-----</option>
                                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option value="<?php echo e($inv->id); ?>"><?php echo e($inv->invoice_number); ?> - <?php echo e($inv->tenant_name); ?> | Balance: <?php echo e($inv->balance); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/manualinvoices/pay.blade.php ENDPATH**/ ?>