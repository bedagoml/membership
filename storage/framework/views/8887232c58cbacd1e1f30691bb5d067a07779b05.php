						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Subscription Category</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('subscription.store')); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                ...
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div>
                                <input class="form-control" type="date"  name="subscription_date"
                                    value="<?php echo e(old('')); ?>">
                            </div>
                            </div>
                            <div class="col-sm-6">
                                <label>New Membership Category<span class="text-danger">*</span></label>
                                <div>
                                    <input class="form-control" placeholder="Enter New Membership category" type="text"  name="category"
                                        value="">
                                </div>
                                </div>
                            </div><br>
                             ...
                             <div class="col-sm-4" >
                                    <div class="form-group">
                                        <label >Registration Amount<span class="text-danger">*</span></label>
                                           <div>
                                            <div class="form-group">
                                                <input class="form-control " placeholder="Enter Membership Registration Amount" type="number" name="registration_amount"
                                            value="">
                                ...
                                <div class="col-sm-4" >
                                    <div class="form-group">
                                        <label >Renewal Amount<span class="text-danger">*</span></label>
                                           <div>
                                            <div class="form-group">
                                                <input class="form-control " placeholder="Enter Membership Renewal Amount" type="number" name="renewal_amount"
                                            value="">
                                ...
                                <div class="col-sm-4" >
                                    <div class="form-group">
                                        <label >Accreditation/License Amount<span class="text-danger">*</span></label>
                                           <div>
                                            <div class="form-group">
                                                <input class="form-control " placeholder="Enter Accreditation/License Amount" type="number" name="license_amount"
                                            value="">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Create Membership Category</button></button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/subscriptions/create.blade.php ENDPATH**/ ?>