            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                            <label>Select Meeting<span class="text-danger">*</span></label>
                            <div>
                                <select class="form-control select2-show-search" style="width: 100%"  name="meeting_id">

                                    <option selected disabled>-----Select-----</option>
                                    <?php $__empty_1 = true; $__currentLoopData = $meeting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meet=>$key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($key); ?>"><?php echo e($meet->title); ?></option>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Submit Roll Call</button></button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rent\rms\resources\views/users/tenant/attendance.blade.php ENDPATH**/ ?>