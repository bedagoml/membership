                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <select id="invoiceTypeSelector" class="form-control select2-show-search" style="width: 100%" name="bill_category">
    
                                        
                                        <option value="Projects" selected>Projects</option>
                                        <option value="Administration">Administaration</option>
                            ...
                            <div>
                                <div class="form-group">
                           <select class="form-control select2-show-search" style="width: 100%" name="bill_id">
                           ...
                           <option value="<?php echo e($pay->id); ?>">(Bill #<?php echo e($pay->id); ?> Type: <?php echo e($pay->bill_type); ?>) - To Pay: <?php echo e($pay->balance); ?></option>
                          <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/bills/pay.blade.php ENDPATH**/ ?>