	...
	<form action="<?php echo e(route('subscription.store')); ?>" method="post" class="card">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                        <h6 class="mt-0 header-title mb-4"><strong>Note: Only create a subscription when none exists, otherwise go to edit section</strong></h6>
                                ...
                                <div class="form-group">
                                    <label >Registration Amount<span class="text-danger">*</span></label>
                                       <div>
                                        ...
                                        value="">
                                        <input class="form-control "  type="hidden" name="is_admin"
                                        value="1">
                                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Create Subscription</button></button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotary\rotary\resources\views/subscriptions/create.blade.php ENDPATH**/ ?>