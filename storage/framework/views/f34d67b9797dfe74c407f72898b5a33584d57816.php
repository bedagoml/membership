							...
							<div class="container-fluid">
								<div class="d-flex">
									...
									<a class="header-brand1 d-flex d-md-none" href="index.html">
										...
										<img src="<?php echo e(URL::asset('assets/assets/images/brand/logo.png')); ?>" class="header-brand-img toggle-logo" alt="logo">
										<img src="<?php echo e(URL::asset('assets/assets/images/brand/logo.png')); ?>" class="header-brand-img light-logo" alt="logo">
										<img src="<?php echo e(URL::asset('assets/assets/images/brand/logo.png')); ?>" class="header-brand-img light-logo1" alt="logo">
									</a><!-- LOGO -->
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
												<div class="drop-heading">
													<div class="text-center">
														...
														<small class="text-muted"><?php if(Auth::user()->is_admin==0): ?>Operator 
															<?php elseif(Auth::user()->is_admin==1): ?>Administrator
															<?php else: ?>
																Super Administrator
															 <?php endif; ?></small>
													</div>
						...
						<?php /**PATH C:\xampp\htdocs\rent\rms\resources\views///////layouts/header.blade.php ENDPATH**/ ?>