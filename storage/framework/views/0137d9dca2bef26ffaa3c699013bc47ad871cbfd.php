                                ...
                                <div class="col-md-4">
                                    <div class="profile-info-left">
                                        ...
                                        <div class="mb-2"><a class="btn btn-sm btn-primary"
                                                href="<?php echo e(route('tenant.edit', $tenant->id )); ?>">Edit Member details</a>
                                        </div>
                                        <div class="mb-2"><a class="btn btn-sm btn-danger"
                                            href="<?php echo e(route('tenant.changepassword', $tenant->id )); ?>">Change Member Password</a>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12 d-flex">
                    <div class="card  flex-fill">
                        <div class="card-body">
                            <h3 class="card-title"> <?php echo e($tenant->full_name); ?> Annual Invoice Balances </h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex">
                    <div class="card profile-box flex-fill">
                        <div class="card-body">
                            <h3 class="card-title"><?php echo e($tenant->full_name); ?> Invoices </h3>
                            <div class="table-responsive">
                ...
                <div class="col-md-6 d-flex">
                    <div class="card profile-box flex-fill">
                        <div class="card-body">
                            <h3 class="card-title"><?php echo e($tenant->full_name); ?> Payments </h3>
                            <div class="table-responsive">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rent\rms\resources\views/tenants/show.blade.php ENDPATH**/ ?>