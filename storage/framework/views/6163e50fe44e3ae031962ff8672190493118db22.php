                ...
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label>Meeting Description <span class="text-danger">*</span></label>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Schedule Meeting</button></button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rent\rms\resources\views/meeting/index.blade.php ENDPATH**/ ?>