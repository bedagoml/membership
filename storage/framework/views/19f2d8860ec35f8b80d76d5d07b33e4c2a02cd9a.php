                    ...
                    <div class="">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <input class="form-control " type="tel" name="type"
                                                value="<?php echo e($invoice->type); ?>" readonly>
                                </div>
                                <div class="col-sm-6" >
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-sm-4" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="<?php if($invoice->tenant_id != null): ?><?php echo e($invoice->tenant->member_number); ?><?php else: ?> No Member Number Assigned <?php endif; ?>" readonly>
                                    ...
                                    <div class="col-sm-4" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="form-group">
                                                 <?php if($invoice->type == "First Subscription Invoice"): ?>  
                                                        <input class="form-control" type="number" name="amount"
                                                value="<?php echo e($invoice->amount); ?>" >
                                               <?php else: ?>
                                               <input class="form-control" type="number" name="renewal"
                                               value="<?php echo e($invoice->renewal); ?>" >
                                               <?php endif; ?>
                                                </div>
                                    ...
                                    <div class="col-sm-4" >
                                        <div class="form-group">
                                            ...
                                            <label>Accreditation/License Amount</label>
                                            <div>
                                                <div class="form-group">
                                               
                                                        <input class="form-control" type="text" name="license"
                                                value="<?php echo e($invoice->license); ?>" >
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\membership\rms\resources\views/invoices/edit.blade.php ENDPATH**/ ?>