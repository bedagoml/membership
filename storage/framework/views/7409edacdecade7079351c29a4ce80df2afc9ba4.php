...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
        <form action="<?php echo e(route('income_statement')); ?>" method="get">
            <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-striped dt-responsive nowrap" id="statement" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <th><?php echo e($entry['member_name']); ?></th>
                                ...
                                <?php else: ?> 
                                <td >
                                    Ksh. <?php echo e(number_format($entry['paid_in'],2)); ?>
                                ...
                                <?php else: ?> 
                                <td >
                                    Ksh. <?php echo e(number_format($entry['paid'],2)); ?>
                                ...
                                <?php else: ?> 
                                <td >
                                    Ksh. <?php echo e(number_format($entry['happy'],2)); ?>

                                </td>
                                <?php endif; ?>
                                <?php if($entry['happy_1'] === '-'): ?>
                                <td>
                                    -
                                </td>
                                <?php else: ?> 
                                <td >
                                    Ksh. <?php echo e(number_format($entry['happy_1'],2)); ?>

                                </td>
                                <?php endif; ?>
                                <?php if($entry['happy_2'] === '-'): ?>
                                <td>
                                    -
                                </td>
                                <?php else: ?> 
                                <td >
                                    Ksh. <?php echo e(number_format($entry['happy_2'],2)); ?>
                    ...
                    <div class="row table-responsive   ">
                        <table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Subscription</td>
                                    <td>Ksh. <?php echo e($payments); ?></td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td>Projects</td>
                                    <td>Ksh. <?php echo e($donationpayments); ?></td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td>Happy Hundreds</td>
                                    <td>Ksh. <?php echo e($happy_hours_payments); ?></td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td>Total Expenses</td>
                                    <td>-</td>
                                    <td>Ksh. <?php echo e($expense); ?></td>
                                </tr>
                                <tr>
                                    <td>Total Expenses Payment</td>
                                    <td>-</td>
                                    <td>Ksh. <?php echo e($expensepay); ?></td>
                                </tr>
                                <hr>
                                <tr>
                                    <th>Total Expenses Balance</th>
                                    <th>-</th>
                                    <th>Ksh. <?php echo e($expensebalance); ?></th>
                                </tr>
                                <tr>
                                    <th>Total Income</th>
                                    <th >Ksh. <?php echo e($total_income); ?></th>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <th>Account Balance</th>
                                    <th >Ksh. <?php echo e($balance); ?></th>
                                    <td>-</td>
                                </tr>
                            </tbody>
                          </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rotary\rotary\resources\views/report/incomeform.blade.php ENDPATH**/ ?>