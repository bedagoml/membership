...
<?php $__env->startSection('content'); ?>
	...
	<form action="<?php echo e(route('meeting.update', $event->id)); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div>
                                <input class="form-control" type="date"  name="meeting_date"
                                    value="<?php echo e($event->meeting_date); ?>">
                            </div>
                            </div>
                            <div class="col-sm-6" >
                                <div class="form-group">
                                    ...
                                    value="<?php echo e($event->meeting_time); ?>">
                                    </div>
                                </div>
                            </div></div> <br>
                                ...
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                        <label >Event Title<span class="text-danger">*</span></label>
                                           <div>
                                            <div class="form-group">
                                                <input class="form-control " placeholder="Enter Event Title" type="text" name="meeting_title"
                                            value="<?php echo e($event->meeting_title); ?>">
                                ...
                                <div class="col-sm-6" >
                                    <div class="form-group">
                                        <label >Amount</label>
                                           <div>
                                            <div class="form-group">
                                                <input class="form-control " placeholder="Enter Event Price (Leave blank for free events)" type="number" name="meeting_amount"
                                            value="<?php echo e($event->meeting_amount); ?>">
                            ...
                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea name="meeting_description" class="form-control" rows="6"  ><?php echo e($event->meeting_description); ?></textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Edit Scheduled Event</button></button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/meeting/edit.blade.php ENDPATH**/ ?>