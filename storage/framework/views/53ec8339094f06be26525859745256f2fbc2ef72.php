                  ...
                  <table class="table table-striped"  id="bill-table" style="width:100%">
                            <thead>
                                 <tr>
                                    ...
                                    <th style="width:20%">Bill Category</th>
        ...
        $('#bill-table').DataTable({
            ...
            columns: [ 
               { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false},     
                    //  { data: 'id', name: 'id' },
                    { data: 'agency_user', name: 'agency_user',orderable: false },
                    { data: 'bill_category', name: 'bill_category', orderable: false },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/payowners/list.blade.php ENDPATH**/ ?>