                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <select id="placementSelector" class="form-control select2-show-search" style="width: 100%"  name="type">
                                ...
                                <option value="annual_subscription" selected>Subscription Fee</option>
                            ...
                            <div class="col-sm-4">
                            <label >Selected Member <span class="text-danger">*</span></label>
                           <input class="form-control" type="text" name=""
                                            value="<?php echo e($tenants->full_name); ?>" readonly>
                             <input type="hidden" class="form-control" name="tenant_id"
                                            value="<?php echo e($tenants->id); ?>" >
                            </div>
                             <div class="col-sm-4" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/manualinvoices/acccreate.blade.php ENDPATH**/ ?>