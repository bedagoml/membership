            ...
            <div class="card">
                <div class="card-body">
                 <div class="tab">
                  ...
                  <button class="tablinks" onclick="openCity(event, 'Tenants')">Members</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/democlai/public_html/members/rms/resources/views/logs/index.blade.php ENDPATH**/ ?>