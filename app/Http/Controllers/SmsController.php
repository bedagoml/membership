...
class SmsController extends Controller
{
    ...
    public function sendSms(Request $request)
    {
        ...
        // $smses = null;
        return view('sms.custom', compact('tenants', 'landlords','smses','sms_count'));
        }else{
    ...
    private function formatSms($message, $tags, $usr, $typ){
        ...
        $tenant_full_name = $usr->full_name;
        ...
        $srt = str_replace("[Tenant Fullname]",$usr->full_name,$srt);
        $srt = str_replace("[Tenant Account Number]",$usr->account_number,$srt);
        $srt = str_replace("[Tenant Balance]",$invoice_balances, $srt);
        $srt = str_replace("[Tenant Phone]",$usr->phone, $srt);
            return $srt;
        }else if($typ === 'owner'){
    ...
    public function custom()
    {
        ...
        $tenants = Tenant::pluck('id', 'full_name');
        $smses = null;
        return view('sms.custom', compact('tenants', 'landlords','smses'));
    }
