...
class ReportController extends Controller
{
    ...
    public function incomeform()
    {
        ...
        $hasReport = false;
        return view('report.incomeform', compact('hasReport'));
    }
    public function eventform()
    {
        $events = Meeting::pluck('id', 'meeting_title');
        $hasReport = false;
        return view('report.eventform', compact('events','hasReport'));
    }
    ...
    {    
        ...
        break;
         case 'tenant_balances':
            $info = Invoice::with('apartment','house','tenant')->where('apartment_id',$request->apartment)->where('balance','>',0)->get()->groupBy('tenant_id');
